...
function startTime(minutes, seconds) {
    const totalSeconds = minutes * 60 + seconds;
    const initialTime = new Date().setSeconds(new Date().getSeconds() + totalSeconds + 2);
    ...
    setInterval(() => {
        ...
        if (timeDiff <= 10) {
            console.log(chalk.red(`${minute.toString().padStart(2, "0")}:${seconds
                .toString()
                .padStart(2, "0")}`));
        }
        else {
